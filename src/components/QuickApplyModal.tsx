...
export default function QuickApplyModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  if (!open) return null;
  return (
        ...
        <div className="p-8 pb-0">
          ...
          <div className="flex items-center gap-8 mb-6">
            ...
            <div className="flex-1 flex justify-end">
              <button className="px-4 py-2 rounded-lg bg-gray-100 text-gray-700 font-medium text-sm">Select All</button>
            </div>
          </div>
        </div>
        {/* Job cards */}
        ...
        <div className="px-8 py-4 border-t border-gray-100 bg-gray-50 rounded-b-2xl flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between mt-2">
            <div className="text-blue-700 bg-blue-100 px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2">
              Ready to apply to 1 jobs in ~1 minutes
            </div>
            <div className="flex gap-3">
              ...
              <button className="px-4 py-2 rounded-lg bg-blue-600 text-white font-semibold text-sm flex items-center gap-2"><CheckCircle className="h-4 w-4" /> Apply to 1 Jobs</button>
            </div>
          </div>
        </div>
      </div>
